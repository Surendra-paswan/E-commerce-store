...
const About = () => {
  ...
  //               prices. At our store, we blend technology with trends to bring
  //               you the best in online shopping.
  //             </p>
  //           </div>
  //         </section>
  ...
  //               With premium products, fast delivery, and outstanding customer
  //               service, we strive to create an experience you can trust and
  //               enjoy.
  //             </p>
  //           </div>
  //         </section>
  ...
  //                   Only the finest products from verified brands and suppliers.
  //                 </p>
  //               </div>
  //               <div className="p-6 rounded-lg border border-gray-200 shadow hover:shadow-lg transition">
  //                 <h4 className="text-xl font-semibold mb-2 text-teal-600">
